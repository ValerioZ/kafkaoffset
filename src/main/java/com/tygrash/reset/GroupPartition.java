...
//    public GroupPartition(String p_consumerGroup, String p_kafkaTopic, int p_partition, Long p_offset) {
//        this.consumerGroup = p_consumerGroup;
//        this.kafkaTopic = p_kafkaTopic;
//        this.partitionNumber = p_partition;
//        this.newOffset = p_offset;
//
//    }
